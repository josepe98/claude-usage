...
# malicious or stale client cant smuggle arbitrary strings into the
...
AWESOME_CATALOG = [
    ...
    {"id": "mistral.ai",    "name": "Mistral AI",    "category": "AI & ML"},
    {"id": "ollama",        "name": "Ollama",        "category": "AI & ML"},
    {"id": "replicate",     "name": "Replicate",     "category": "AI & ML"},
    {"id": "runwayml",      "name": "RunwayML",      "category": "AI & ML"},
    {"id": "together.ai",   "name": "Together AI",   "category": "AI & ML"},
    {"id": "x.ai",          "name": "xAI",           "category": "AI & ML"},
    # Developer Tools
    ...
    {"id": "opencode.ai",   "name": "OpenCode",      "category": "Developer Tools"},
    ...
    {"id": "slack",         "name": "Slack",         "category": "Design & Productivity"},
    {"id": "theverge",      "name": "The Verge",     "category": "Design & Productivity"},
    {"id": "webflow",       "name": "Webflow",       "category": "Design & Productivity"},
    {"id": "wired",         "name": "WIRED",         "category": "Design & Productivity"},
    # Fintech & Crypto
    {"id": "binance",       "name": "Binance",       "category": "Fintech & Crypto"},
    ...
    {"id": "dell-1996",     "name": "Dell (1996)",   "category": "Enterprise & Consumer"},
    {"id": "hp",            "name": "HP",            "category": "Enterprise & Consumer"},
    {"id": "ibm",           "name": "IBM",           "category": "Enterprise & Consumer"},
    {"id": "meta",          "name": "Meta",          "category": "Enterprise & Consumer"},
    {"id": "nike",          "name": "Nike",          "category": "Enterprise & Consumer"},
    {"id": "nintendo-2001", "name": "Nintendo (2001)","category": "Enterprise & Consumer"},
    {"id": "nvidia",        "name": "NVIDIA",        "category": "Enterprise & Consumer"},
    {"id": "playstation",   "name": "PlayStation",   "category": "Enterprise & Consumer"},
    {"id": "spacex",        "name": "SpaceX",        "category": "Enterprise & Consumer"},
    {"id": "spotify",       "name": "Spotify",       "category": "Enterprise & Consumer"},
    {"id": "starbucks",     "name": "Starbucks",     "category": "Enterprise & Consumer"},
    {"id": "uber",          "name": "Uber",          "category": "Enterprise & Consumer"},
    {"id": "vodafone",      "name": "Vodafone",      "category": "Enterprise & Consumer"},
    # Car Brands
    {"id": "bmw",           "name": "BMW",           "category": "Car Brands"},
    {"id": "bmw-m",         "name": "BMW M",         "category": "Car Brands"},
    {"id": "bugatti",       "name": "Bugatti",       "category": "Car Brands"},
...
const DASHBOARD_BLOCK_IDS = [
  'stats-row', 'pareto-card', 'charts-grid-main',
  'cost-by-model-table', 'recent-sessions-table', 'session-detail-card',
  'cost-by-project-table', 'cost-by-project-branch-table',
];
