...
class TestSessionDetailCostFields(unittest.TestCase):
    ...
    def test_cumulative_cost_is_running_sum(self):
        ...
        # cum_cost on turn 0 equals its own cost; turn 1 == turn0.cost + turn1.cost
    ...
    def test_existing_fields_still_present(self):
        # The consolidation must not drop the existing payload.
        d = dashboard.get_session_detail("abc12345-foo")
    ...
    def test_modal_dom_and_helpers_are_gone(self):
        # Modal HTML, JS helpers, and the dedicated endpoint were
        # consolidated away — the inline card is the only drill-down.
